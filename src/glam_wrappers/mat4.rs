...
impl From<DMat4> for PyDMat4 {
    #[inline]
    fn from(m: DMat4) -> Self { Self(m) }
}

impl From<PyDMat4> for DMat4 {
    #[inline]
    fn from(m: PyDMat4) -> Self { m.0 }
}
...
mod pyo3_impl {
    ...
    impl<'a, 'py> pyo3::FromPyObject<'a, 'py> for PyDMat4 {
        ...
        fn extract(ob: pyo3::Borrowed<'a, 'py, pyo3::PyAny>) -> pyo3::PyResult<Self> {
            ...
            let cols: (
                ...
                (f64, f64, f64, f64),
                (f64, f64, f64, f64),
            ) = ob.call_method0(pyo3::intern!(py, "to_cols_array_2d"))?.extract()?;
    ...
    impl PyDMat4 {
        ...
        fn new(
            ...
            match (x_axis, y_axis, z_axis, w_axis) {
                (Some(x), Some(y), Some(z), Some(w)) => Ok(Self(DMat4::from_cols(x.0, y.0, z.0, w.0))),
        ...
        #[staticmethod]
        #[inline]
        fn from_cols_array(m: [f64; 16]) -> Self { Self(DMat4::from_cols_array(&m)) }
        #[staticmethod]
        #[inline]
        fn from_cols_array_2d(m: [[f64; 4]; 4]) -> Self { Self(DMat4::from_cols_array_2d(&m)) }
        #[staticmethod]
        #[inline]
        ...
        #[staticmethod]
        #[inline]
        fn from_diagonal(diagonal: PyDVec4) -> Self { Self(DMat4::from_diagonal(diagonal.0)) }
        #[staticmethod]
        #[inline]
        fn from_scale_rotation_translation(scale: PyDVec3, rotation: PyDQuat, translation: PyDVec3) -> Self {
            Self(DMat4::from_scale_rotation_translation(scale.0, rotation.0, translation.0))
        }
        #[staticmethod]
        #[inline]
        ...
        #[staticmethod]
        #[inline]
        fn from_quat(rotation: PyDQuat) -> Self { Self(DMat4::from_quat(rotation.0)) }
        #[staticmethod]
        #[inline]
        fn from_mat3(m: PyDMat3) -> Self { Self(DMat4::from_mat3(m.0)) }
        #[staticmethod]
        #[inline]
        fn from_mat3_translation(mat3: PyDMat3, translation: PyDVec3) -> Self { Self(DMat4::from_mat3_translation(mat3.0, translation.0)) }
        #[staticmethod]
        #[inline]
        fn from_translation(translation: PyDVec3) -> Self { Self(DMat4::from_translation(translation.0)) }
        #[staticmethod]
        #[inline]
        fn from_axis_angle(axis: PyDVec3, angle: f64) -> Self { Self(DMat4::from_axis_angle(axis.0, angle)) }
        #[staticmethod]
        #[inline]
        fn from_euler(order: PyEulerRot, a: f64, b: f64, c: f64) -> Self { Self(DMat4::from_euler(order.into(), a, b, c)) }
        #[staticmethod]
        #[inline]
        fn from_rotation_x(angle: f64) -> Self { Self(DMat4::from_rotation_x(angle)) }
        #[staticmethod]
        #[inline]
        fn from_rotation_y(angle: f64) -> Self { Self(DMat4::from_rotation_y(angle)) }
        #[staticmethod]
        #[inline]
        fn from_rotation_z(angle: f64) -> Self { Self(DMat4::from_rotation_z(angle)) }
        #[staticmethod]
        #[inline]
        fn from_scale(scale: PyDVec3) -> Self { Self(DMat4::from_scale(scale.0)) }
    }
    ...
    impl PyDMat4 {
        ...
        #[staticmethod]
        fn frustum_rh_gl(left: f64, right: f64, bottom: f64, top: f64, z_near: f64, z_far: f64) -> Self {
            Self(DMat4::frustum_rh_gl(left, right, bottom, top, z_near, z_far))
        }
        #[staticmethod]
    ...
    impl PyDMat4 {
        #[staticmethod]
        fn look_to_lh(eye: PyDVec3, dir: PyDVec3, up: PyDVec3) -> Self { Self(DMat4::look_to_lh(eye.0, dir.0, up.0)) }
        #[staticmethod]
        fn look_to_rh(eye: PyDVec3, dir: PyDVec3, up: PyDVec3) -> Self { Self(DMat4::look_to_rh(eye.0, dir.0, up.0)) }
        #[staticmethod]
        fn look_at_lh(eye: PyDVec3, center: PyDVec3, up: PyDVec3) -> Self { Self(DMat4::look_at_lh(eye.0, center.0, up.0)) }
        #[staticmethod]
        fn look_at_rh(eye: PyDVec3, center: PyDVec3, up: PyDVec3) -> Self { Self(DMat4::look_at_rh(eye.0, center.0, up.0)) }
    }
    ...
    impl PyDMat4 {
        #[getter]
        #[inline]
        fn x_axis(&self) -> PyDVec4 { PyDVec4(self.0.x_axis) }
        #[getter]
        #[inline]
        fn y_axis(&self) -> PyDVec4 { PyDVec4(self.0.y_axis) }
        #[getter]
        #[inline]
        fn z_axis(&self) -> PyDVec4 { PyDVec4(self.0.z_axis) }
        #[getter]
        #[inline]
        fn w_axis(&self) -> PyDVec4 { PyDVec4(self.0.w_axis) }

        #[inline]
        fn col(&self, index: usize) -> PyResult<PyDVec4> {
            if index < 4 { Ok(PyDVec4(self.0.col(index))) }
            else { Err(PyIndexError::new_err("column index out of range")) }
        }
        #[inline]
        fn row(&self, index: usize) -> PyResult<PyDVec4> {
            if index < 4 { Ok(PyDVec4(self.0.row(index))) }
            else { Err(PyIndexError::new_err("row index out of range")) }
        }
    }
    ...
    impl PyDMat4 {
        #[inline]
        fn to_cols_array(&self) -> [f64; 16] { self.0.to_cols_array() }
        #[inline]
        fn to_cols_array_2d(&self) -> [[f64; 4]; 4] { self.0.to_cols_array_2d() }
        #[inline]
    ...
    impl PyDMat4 {
        #[inline]
        fn diagonal(&self) -> PyDVec4 { PyDVec4(self.0.diagonal()) }
        #[inline]
        fn determinant(&self) -> f64 { self.0.determinant() }
        #[inline]
        fn transpose(&self) -> Self { Self(self.0.transpose()) }
        #[inline]
        fn inverse(&self) -> Self { Self(self.0.inverse()) }
        #[inline]
        fn try_inverse(&self) -> Option<Self> { self.0.try_inverse().map(Self) }
        #[inline]
        fn inverse_or_zero(&self) -> Self { Self(self.0.inverse_or_zero()) }
        #[inline]
        ...
        #[inline]
        fn to_euler(&self, order: PyEulerRot) -> (f64, f64, f64) { self.0.to_euler(order.into()) }
    }

    #[pymethods]
    impl PyDMat4 {
        #[inline]
        fn mul_vec4(&self, rhs: PyDVec4) -> PyDVec4 { PyDVec4(self.0.mul_vec4(rhs.0)) }
        #[inline]
        fn mul_transpose_vec4(&self, rhs: PyDVec4) -> PyDVec4 { PyDVec4(self.0.mul_transpose_vec4(rhs.0)) }
        #[inline]
        fn project_point3(&self, rhs: PyDVec3) -> PyDVec3 { PyDVec3(self.0.project_point3(rhs.0)) }
        #[inline]
    ...
    impl PyDMat4 {
        #[inline]
        fn mul_mat4(&self, rhs: Self) -> Self { Self(self.0.mul_mat4(&rhs.0)) }
        #[inline]
        fn add_mat4(&self, rhs: Self) -> Self { Self(self.0.add_mat4(&rhs.0)) }
        #[inline]
        fn sub_mat4(&self, rhs: Self) -> Self { Self(self.0.sub_mat4(&rhs.0)) }
        #[inline]
        fn mul_scalar(&self, rhs: f64) -> Self { Self(self.0.mul_scalar(rhs)) }
        #[inline]
        fn div_scalar(&self, rhs: f64) -> Self { Self(self.0.div_scalar(rhs)) }
        #[inline]
        fn mul_diagonal_scale(&self, scale: PyDVec4) -> Self { Self(self.0.mul_diagonal_scale(scale.0)) }
    }
    ...
    impl PyDMat4 {
        #[classattr]
        #[pyo3(name = "IDENTITY")]
        fn identity_const() -> Self { Self(DMat4::IDENTITY) }
        #[classattr]
        #[pyo3(name = "ZERO")]
        fn zero_const() -> Self { Self(DMat4::ZERO) }
        #[classattr]
        #[pyo3(name = "NAN")]
        fn nan_const() -> Self { Self(DMat4::NAN) }
    }
    ...
    impl PyDMat4 {
        ...
        fn __rmul__(&self, other: &Bound<'_, PyAny>) -> PyResult<Self> {
            if let Ok(s) = other.extract::<f64>() { Ok(Self(s * self.0)) }
            else { Err(pyo3::exceptions::PyTypeError::new_err("unsupported operand type for *")) }
        }

        fn __add__(&self, other: Self) -> Self { Self(self.0 + other.0) }
        fn __sub__(&self, other: Self) -> Self { Self(self.0 - other.0) }
        fn __truediv__(&self, other: f64) -> Self { Self(self.0 / other) }

        fn __array__<'py>(&self, py: Python<'py>) -> Bound<'py, PyArray2<f64>> { self.to_numpy(py) }
    }
...
mod rustpython_impl {
    use super::*;
    use crate::glam_wrappers::{PyDVec3, PyDVec4, vec3::extract_vec3, vec4::extract_vec4};
    use rustpython_vm::{
    ...
    impl PyDMat4 {
        ...
        #[pystaticmethod]
        fn from_cols(x: PyObjectRef, y: PyObjectRef, z: PyObjectRef, w: PyObjectRef, vm: &VirtualMachine) -> PyResult<Self> {
        ...
        fn from_translation(translation: PyObjectRef, vm: &VirtualMachine) -> PyResult<Self> {
            Ok(Self(DMat4::from_translation(extract_vec3(&translation, vm)?)))
        }
        #[pystaticmethod]
        ...
        fn from_axis_angle(axis: PyObjectRef, angle: f64, vm: &VirtualMachine) -> PyResult<Self> {
            Ok(Self(DMat4::from_axis_angle(extract_vec3(&axis, vm)?, angle)))
        }
        #[pystaticmethod]
        fn from_rotation_x(angle: f64) -> Self { Self(DMat4::from_rotation_x(angle)) }
        #[pystaticmethod]
        ...
        #[pystaticmethod]
        fn look_at_rh(eye: PyObjectRef, center: PyObjectRef, up: PyObjectRef, vm: &VirtualMachine) -> PyResult<Self> {
            Ok(Self(DMat4::look_at_rh(extract_vec3(&eye, vm)?, extract_vec3(&center, vm)?, extract_vec3(&up, vm)?)))
        }
        #[pystaticmethod]
        fn look_at_lh(eye: PyObjectRef, center: PyObjectRef, up: PyObjectRef, vm: &VirtualMachine) -> PyResult<Self> {
            Ok(Self(DMat4::look_at_lh(extract_vec3(&eye, vm)?, extract_vec3(&center, vm)?, extract_vec3(&up, vm)?)))
        }

        #[pymethod]
        fn col(&self, index: usize, vm: &VirtualMachine) -> PyResult<PyDVec4> {
            if index < 4 { Ok(PyDVec4(self.0.col(index))) }
            else { Err(vm.new_index_error("column index out of range".to_owned())) }
        }
        #[pymethod]
        fn row(&self, index: usize, vm: &VirtualMachine) -> PyResult<PyDVec4> {
            if index < 4 { Ok(PyDVec4(self.0.row(index))) }
            else { Err(vm.new_index_error("row index out of range".to_owned())) }
        }
        #[pymethod]
        fn diagonal(&self) -> PyDVec4 { PyDVec4(self.0.diagonal()) }
        #[pymethod]
        ...
        #[pyclassmethod]
        fn IDENTITY(_cls: rustpython_vm::builtins::PyTypeRef) -> Self { Self(DMat4::IDENTITY) }
        #[pyclassmethod]
        fn ZERO(_cls: rustpython_vm::builtins::PyTypeRef) -> Self { Self(DMat4::ZERO) }
    }
}
