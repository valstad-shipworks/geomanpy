...
#[cfg_attr(
    ...
    rustpython_vm::pyclass(module = "_geomanpy", name = "Mat3")
)]
...
impl From<DMat3> for PyDMat3 {
    #[inline]
    fn from(m: DMat3) -> Self { Self(m) }
}

impl From<PyDMat3> for DMat3 {
    #[inline]
    fn from(m: PyDMat3) -> Self { m.0 }
}
...
mod pyo3_impl {
    ...
    impl PyDMat3 {
        ...
        #[staticmethod]
        #[inline]
        fn from_cols_array(m: [f64; 9]) -> Self { Self(DMat3::from_cols_array(&m)) }
        #[staticmethod]
        #[inline]
        fn from_cols_array_2d(m: [[f64; 3]; 3]) -> Self { Self(DMat3::from_cols_array_2d(&m)) }
        #[staticmethod]
        #[inline]
        ...
        #[staticmethod]
        #[inline]
        fn from_diagonal(diagonal: PyDVec3) -> Self { Self(DMat3::from_diagonal(diagonal.0)) }
        #[staticmethod]
        #[inline]
        fn from_quat(rotation: PyDQuat) -> Self { Self(DMat3::from_quat(rotation.0)) }
        #[staticmethod]
        #[inline]
        fn from_axis_angle(axis: PyDVec3, angle: f64) -> Self { Self(DMat3::from_axis_angle(axis.0, angle)) }
        #[staticmethod]
        #[inline]
        ...
        #[staticmethod]
        #[inline]
        fn from_rotation_x(angle: f64) -> Self { Self(DMat3::from_rotation_x(angle)) }
        #[staticmethod]
        #[inline]
        fn from_rotation_y(angle: f64) -> Self { Self(DMat3::from_rotation_y(angle)) }
        #[staticmethod]
        #[inline]
        fn from_rotation_z(angle: f64) -> Self { Self(DMat3::from_rotation_z(angle)) }
        #[staticmethod]
        #[inline]
        fn from_angle(angle: f64) -> Self { Self(DMat3::from_angle(angle)) }
        #[staticmethod]
        #[inline]
        fn from_translation(translation: PyDVec2) -> Self { Self(DMat3::from_translation(translation.0)) }
        #[staticmethod]
        #[inline]
        fn from_scale(scale: PyDVec2) -> Self { Self(DMat3::from_scale(scale.0)) }
        #[staticmethod]
        #[inline]
        fn from_scale_angle_translation(scale: PyDVec2, angle: f64, translation: PyDVec2) -> Self {
            Self(DMat3::from_scale_angle_translation(scale.0, angle, translation.0))
        }
        #[staticmethod]
        #[inline]
        fn from_mat4(m: PyDMat4) -> Self { Self(DMat3::from_mat4(m.0)) }
        #[staticmethod]
        #[inline]
        fn from_mat4_minor(m: PyDMat4, i: usize, j: usize) -> Self { Self(DMat3::from_mat4_minor(m.0, i, j)) }
        #[staticmethod]
        #[inline]
        fn look_to_lh(dir: PyDVec3, up: PyDVec3) -> Self { Self(DMat3::look_to_lh(dir.0, up.0)) }
        #[staticmethod]
        #[inline]
        fn look_to_rh(dir: PyDVec3, up: PyDVec3) -> Self { Self(DMat3::look_to_rh(dir.0, up.0)) }
    }
    ...
    impl PyDMat3 {
        #[getter]
        #[inline]
        fn x_axis(&self) -> PyDVec3 { PyDVec3(self.0.x_axis) }
        #[getter]
        #[inline]
        fn y_axis(&self) -> PyDVec3 { PyDVec3(self.0.y_axis) }
        #[getter]
        #[inline]
        fn z_axis(&self) -> PyDVec3 { PyDVec3(self.0.z_axis) }

        #[inline]
        fn col(&self, index: usize) -> PyResult<PyDVec3> {
            if index < 3 { Ok(PyDVec3(self.0.col(index))) }
            else { Err(PyIndexError::new_err("column index out of range")) }
        }
        #[inline]
        fn row(&self, index: usize) -> PyResult<PyDVec3> {
            if index < 3 { Ok(PyDVec3(self.0.row(index))) }
    ...
    impl PyDMat3 {
        #[inline]
        fn to_cols_array(&self) -> [f64; 9] { self.0.to_cols_array() }
        #[inline]
        fn to_cols_array_2d(&self) -> [[f64; 3]; 3] { self.0.to_cols_array_2d() }
        #[inline]
    ...
    impl PyDMat3 {
        #[inline]
        fn diagonal(&self) -> PyDVec3 { PyDVec3(self.0.diagonal()) }
        #[inline]
    ...
    impl PyDMat3 {
        #[inline]
        fn mul_vec3(&self, rhs: PyDVec3) -> PyDVec3 { PyDVec3(self.0.mul_vec3(rhs.0)) }
        #[inline]
        fn mul_transpose_vec3(&self, rhs: PyDVec3) -> PyDVec3 { PyDVec3(self.0.mul_transpose_vec3(rhs.0)) }
        #[inline]
        fn transform_point2(&self, rhs: PyDVec2) -> PyDVec2 { PyDVec2(self.0.transform_point2(rhs.0)) }
        #[inline]
        fn transform_vector2(&self, rhs: PyDVec2) -> PyDVec2 { PyDVec2(self.0.transform_vector2(rhs.0)) }
    }

    #[pymethods]
    impl PyDMat3 {
        #[inline]
        fn mul_mat3(&self, rhs: Self) -> Self { Self(self.0.mul_mat3(&rhs.0)) }
        #[inline]
        fn add_mat3(&self, rhs: Self) -> Self { Self(self.0.add_mat3(&rhs.0)) }
        #[inline]
        fn sub_mat3(&self, rhs: Self) -> Self { Self(self.0.sub_mat3(&rhs.0)) }
        #[inline]
        fn mul_scalar(&self, rhs: f64) -> Self { Self(self.0.mul_scalar(rhs)) }
        #[inline]
        fn div_scalar(&self, rhs: f64) -> Self { Self(self.0.div_scalar(rhs)) }
        #[inline]
        fn mul_diagonal_scale(&self, scale: PyDVec3) -> Self { Self(self.0.mul_diagonal_scale(scale.0)) }
    }
    ...
    impl PyDMat3 {
        #[classattr]
        #[pyo3(name = "IDENTITY")]
        fn identity_const() -> Self { Self(DMat3::IDENTITY) }
        #[classattr]
        #[pyo3(name = "ZERO")]
        fn zero_const() -> Self { Self(DMat3::ZERO) }
        #[classattr]
        #[pyo3(name = "NAN")]
        fn nan_const() -> Self { Self(DMat3::NAN) }
    }
...
mod rustpython_impl {
    use super::*;
    use crate::glam_wrappers::{PyDVec2, PyDVec3, vec2::extract_vec2, vec3::extract_vec3};
    use rustpython_vm::{
    ...
    impl PyDMat3 {
        ...
        #[pystaticmethod]
        fn from_cols(x_axis: PyObjectRef, y_axis: PyObjectRef, z_axis: PyObjectRef, vm: &VirtualMachine) -> PyResult<Self> {
            Ok(Self(DMat3::from_cols(
        ...
        fn from_axis_angle(axis: PyObjectRef, angle: f64, vm: &VirtualMachine) -> PyResult<Self> {
            Ok(Self(DMat3::from_axis_angle(extract_vec3(&axis, vm)?, angle)))
        }
        #[pystaticmethod]
        fn from_rotation_x(angle: f64) -> Self { Self(DMat3::from_rotation_x(angle)) }
        #[pystaticmethod]
        ...
        fn from_translation(translation: PyObjectRef, vm: &VirtualMachine) -> PyResult<Self> {
            Ok(Self(DMat3::from_translation(extract_vec2(&translation, vm)?)))
        }
        #[pystaticmethod]
        ...
        #[pyclassmethod]
        fn IDENTITY(_cls: rustpython_vm::builtins::PyTypeRef) -> Self { Self(DMat3::IDENTITY) }
        #[pyclassmethod]
        fn ZERO(_cls: rustpython_vm::builtins::PyTypeRef) -> Self { Self(DMat3::ZERO) }
    }
}
